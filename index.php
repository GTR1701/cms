...
<body>
    ...
    if (isset($_POST['newTitle']) && isset($_POST['newContent']) && $_GET['post']) {
        $updatePostQuery = 'update posts set title=' . $_POST['newTitle'] . ', contents=' . $_POST['newContent'] . ' where id=' . $_GET['post'] . ';';
